...
# Join table to add whether a player is on offense/defense on a given play
...
positions.loc[(positions['team'] == 'away') & (positions['homePossession'] == False), 'team'] = 'offense'
positions.loc[(positions['team'] == 'away') & (positions['homePossession'] == True), 'team'] = 'defense'
positions.loc[(positions['team'] == 'home') & (positions['homePossession'] == True), 'team'] = 'offense'
positions.loc[(positions['team'] == 'home') & (positions['homePossession'] == False), 'team'] = 'defense'
...
for uniquePlayId in playToIndex.index:
    # Each play has offense and defense
